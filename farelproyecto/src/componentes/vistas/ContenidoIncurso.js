...
class ContenidoIncurso extends Component {
           ...
           <Container style={style.container}>
               <Paper style={style.paper}>
                   ...
                   <Grid item xs={12} md={8}>
                        <Breadcrumbs arial-label="breadcrumb">
                            <Typography color="textPrimary">
                                <ImageIcon style={style.imageIcon} />
                                    Imagenes
                                </Typography>
                        </Breadcrumbs>
                    </Grid>
                   ...
                   <Grid item xs={12} md={8}>
                        <Breadcrumbs arial-label="breadcrumb">
                            <Typography color="textPrimary">
                                <PostAddIcon style={style.postAddIcon} />
                                    Documentos 
                                </Typography>
                        </Breadcrumbs>
                    </Grid>
                   ...
                   <Grid item xs={12} md={8}>
                        <Breadcrumbs arial-label="breadcrumb">
                            <Typography color="textPrimary">
                                <MovieIcon style={style.movieIcon} />
                                    Videos
                                </Typography>
                        </Breadcrumbs>
                    </Grid>
...
export default consumerFirebase(ContenidoIncurso);